...
The current catalog has exactly 60 unique cases: 27 Compile and 33 Runtime. Direct compilation matches all 60 targets (41 Pass and 19 Fail), suite compilation adds one Pass, and runtime matches all 33 cases (22 Pass and 11 RuntimeFail) plus two durable resume observations. The 33 runtime receipts contain 649 expected operation records and validate against the sealed source, inputs, mappings, authorities, policy, Reply, and terminal state.
