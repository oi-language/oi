...
prose-effect 2 name=hidden_write after=prepare_source action=write path=literal:"first.txt" content=result:result_text
prose-effect 3 name=chained_write after=hidden_write action=write path=literal:"second.txt" content=result:result_text
step 4 name=reply_result action=reply value=result:result_text
## Prefix
